Based on the comments from cyberw, I have fixed the issue - https://github.com/locustio/locust/issues/2144
  
Please find the below code for the file - locust-plugins/locust_plugins/users/socketio.py. Please review and commit the code accordingly.
...
class SocketIOUser(User):
    ...
    def connect(self, host: str, header=[], **options):
        self.ws = websocket.create_connection(host, header=header, options)
